...
<template>
  ...
  >
    <div class="relative">
      <!-- <img class="hidden dark:block" :width="size" :height="size" alt="FanJam" src="~/assets/img/icons/256x256-trans.png" /> -->
      <img :width="size" :height="size" alt="FanJam" src="~/assets/img/icons/256x256.png" />
